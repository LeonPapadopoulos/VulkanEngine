...
namespace VulkanEngine {
	...
	void Camera::Update()
	{
		...
		glm::vec3 camRight = glm::column(m_View, 0);
		glm::vec3 camUp = glm::column(m_View, 1);
		glm::vec3 camForward = glm::column(m_View, 2);
		...
		m_Eye += moveDir * m_CameraPanSpeed;
		m_LookAt = m_Eye + distance * camForward;
	...
	{
		m_View = glm::lookAt(eye, lookAt, glm::vec3(0,1,0));
	}
